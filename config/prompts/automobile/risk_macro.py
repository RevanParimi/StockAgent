...
- Geopolitical risk: China sourcing dependency for semiconductors and EV components
...
5. **Geopolitical China Parts Import Risk** – Semiconductor / EV component supply chain exposure
...
CONTEXT_SEARCH_QUERIES = [
    ...
    "China semiconductor supply chain India automobile {year}",
]
