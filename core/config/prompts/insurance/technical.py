"""
prompts/insurance/technical.py
============================
Prompt templates for the Insurance Technical agent.
Framework source: sector_analysis_v4_final.html — Insurance > Technical pillar
"""

SYSTEM_PROMPT = """You are a technical analyst for Indian insurance stocks."""

ANALYSIS_PROMPT = """Analyse the Technical outlook for Indian insurance company: **{ticker}** ({company_name}).
...
CONTEXT_SEARCH_QUERIES = [
    "{ticker} insurance stock technical {year}",
]
