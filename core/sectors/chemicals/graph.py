"""
sectors/chemicals/graph.py
======================
LangGraph StateGraph for the Specialty Chemicals sector.
...
from core.sectors.chemicals.registry import AGENTS, WEIGHTS
