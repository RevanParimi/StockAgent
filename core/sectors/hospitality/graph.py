"""
sectors/hospitality/graph.py
========================
LangGraph StateGraph for the Hospitality & Travel sector.
...
from core.sectors.hospitality.registry import AGENTS, WEIGHTS
