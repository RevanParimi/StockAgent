...
def layer2_pure_functions() -> None:
    ...
    from intelligence.rl.agents.feedback_agent import classify_direction, is_direction_correct
...
def layer6_yfinance() -> None:
    ...
    from intelligence.rl.workflows.daily_review import _fetch_actual_close
