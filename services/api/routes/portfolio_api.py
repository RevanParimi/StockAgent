...
Endpoints (identity comes from the bearer session (M0); AUTH_REQUIRED=false
maps anonymous to the owner)
---------------------------------------------------------------------
...
async def add_watchlist(
    ...
    _store(user["user_id"]).add_watchlist(item)
