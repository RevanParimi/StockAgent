...
from backend.shared.schemas.pipeline import AgentOutput, CompetitiveIntelOutput, CompetitiveIntelSubScores, StockQuery
from backend.sectors.automobile.prompts import competitive_intel as P
