...
from backend.shared.schemas.pipeline import AgentOutput, FundamentalsOutput, FundamentalsSubScores, StockQuery
from backend.sectors.automobile.prompts import fundamentals as P
