...
from backend.shared.schemas.pipeline import AgentOutput, PolicyRegulatoryOutput, PolicyRegulatorySubScores, StockQuery
from backend.sectors.automobile.prompts import policy_regulatory as P
