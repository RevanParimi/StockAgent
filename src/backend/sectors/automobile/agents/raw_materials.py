...
from backend.shared.schemas.pipeline import AgentOutput, RawMaterialsOutput, RawMaterialsSubScores, StockQuery
from backend.sectors.automobile.prompts import raw_materials as P
