...
from backend.shared.schemas.pipeline import AgentOutput, RiskMacroOutput, RiskMacroSubScores, StockQuery
from backend.sectors.automobile.prompts import risk_macro as P
