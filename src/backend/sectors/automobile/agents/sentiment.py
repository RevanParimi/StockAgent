...
from backend.shared.schemas.pipeline import AgentOutput, SentimentOutput, SentimentSubScores, StockQuery
from backend.sectors.automobile.prompts import sentiment as P
