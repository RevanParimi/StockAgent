...
class BFSIMacroPolicyAgent(BaseAgent):
    ...
    @property
    def agent_name(self) -> str: return "macro_policy"

    def _build_prompt(self, query: StockQuery, context: str) -> tuple[str, str]:
        system = """Macro analyst covering the Indian banking system. Focus on RBI policy and systemic credit. Return ONLY valid JSON."""
        user = """Macro and policy environment for {ticker} ({company_name}) as of {analysis_date}.
